...
def add_total_data_service():
    data = request.json
    if (('price_value' in data) and ('product_value' in data)and ('men_price' in data)and 
        ('women_price' in data)and ('men_product' in data)and ('women_product' in data)and ('label' in data)):
        ...
        try:
            new_total_data = Total_price(price_value,product_value,men_price,women_price,
...
def update_total_data_by_id_service(id):
    ...
    if price:
        data = request.json
        if (data and ("price_value" in data) and ('product_value' in data)and ('men_price' in data)and 
        ('women_price' in data)and ('men_product' in data)and ('women_product' in data)and ('label' in data)):
            try:
                price.price_value = data["price_value"]
                price.product_value=data['product_value']
